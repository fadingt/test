...
public class LDAPHelper {
	...
	private void LDAP_connect(String url,String basedn,String usr,String pwd) {
		this.URL = url;
		this.BASEDN = basedn; 
		this.root = usr;
		this.rootpwd = pwd;
		...
		env.put(Context.SECURITY_CREDENTIALS, rootpwd); // 管理员密码
//		env.put("java.naming.batchsize", "10");
	...
	private void reConnectRoot() {
		if( isConnect() ) {
			try {
				ctx.addToEnvironment(Context.SECURITY_PRINCIPAL, root);
				ctx.addToEnvironment(Context.SECURITY_CREDENTIALS, rootpwd);
...
//            ret = "ou="+de_map.get(paths[i])+","+ret;            
	...
	public static void main(String[] args) {
		String URL = "ldap://192.9.200.247:389/";
		String BASEDN = "dc=agree,dc=com"; // 根据自己情况进行修改
		String root= "cn=root,dc=agree,dc=com";
		String rootpwd = "123456";
		String cn = "test";
		String user = "test";
		String pwd = "12345678";
...
//		LDAPHelper ldap = new LDAPHelper();
		...
		ldap.LDAP_connect(URL,BASEDN,root,rootpwd);
