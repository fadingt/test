...
layui.config({
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">小黄人</div>'+
							'<div class="input_btn">'+
	...
	layer.open({
	        ...
	        btn: ['知道了'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>1、加精的原则是：原创的，文字比较多的。或者具有讨论意义的</p><p>2、广告帖肯定要及时删除，特别是现在发广告的人聪明，隐性广告帖多。特别是帖子里网址的，这种帖子如果有可读性，就把网址去掉。如果只是几句，要删。不断发广告刷屏的，要及时制止</p><p>3、帖子主题不突出是网友特别是新网友最不懂的，管理员要及时修改帖子主题，突出帖子中心</p><p>4、适当对帖子加精，好的帖子要及时加，让网友觉得自己被肯定</p><p>5、我们社区建设需要需要大家共同的努力</p><p>笔芯 爱你们~~~~~</p></div>',
